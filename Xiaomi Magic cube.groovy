...
log.debug "dimmerHandler $devices, $direction, $dimstep"
 ...
 def nextColor(devices){
 
 log.debug devices.color
 }
 
 def setColor(devices, nextColor, slaveNumber){
 ...
 def colorReset1(){
 	state.slaveColor1 = 1
    setColor(slave1, slaveColor1)
    }
    
 def colorReset2(){
 	state.slaveColor2 = 1
    setColor(slave2, slaveColor2)
    }
